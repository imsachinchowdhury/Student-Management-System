            ...
            <div class="row bg-danger" id="row">
                <div class="col-md-5 col-sm-5 col-12 m-auto">
                   <label><font size="4"color="white">First name</font></label>
                    ...
                    <br>
                    <label><font size="4"color="white">Qualification</font></label>
                    <input type="text" name="qualification" class="form-control" palceholder="Enter your Qualification">
                    <br>
               ...
               <label><font size="4"color="white">Last name</font></label>
                ...
                <br>
                <label><font size="4"color="white">Teacher Photo</font></label>
...
if(isset($_POST['submit']))
{
    ...
    if($filename!="")
    {
        ...
        $query="INSERT INTO teacher_details(fname,lname,email,qualification,birthdate,mobile,gender,district,city,state,nation,photo) VALUES ('$fname','$lname','$email','$qualification','$birthdate','$mobile','$gender','$district','$city','$state','$nationality','$folder')";
