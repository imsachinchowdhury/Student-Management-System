            ...
            <div class="row bg-danger" id="row">
                <div class="col-md-5 col-sm-5 col-12 m-auto">
                   <label><font size="4"color="white">First name</font></label>
                    ...
                    <input type="text" name="qualification" value="<?php echo $fatnm ?>" class="form-control" palceholder="Enter your Qualification">
                    <br>
    ...
    <?php
        if(isset($_POST['submit']))
        {
            ...
            if($filename!="")
            {
                ...
                $query="UPDATE teacher_details SET id='$id',qualification='$qualification',lname='$lname',email='$email',father_name='$fathername',birthdate='$birthdate',mobile='$mobile',gender='$gender',district='$district',city='$city',state='$state',nation='$nationality',photo='$folder' WHERE id='$id'";
